...
export const projects: Project[] = [
  ...
  {
    slug: 'safari-nursery',
    name: "Safari Nursery Room",
    category: 'nursery',
    description:
      'This nursery was conceived around a safari adventure theme, bringing the spirit of the wild into a warm and nurturing space. A palette of earthy tones, warm neutrals, and natural textures creates a grounded and soothing environment, while playful animal references add character and storytelling to the design. Every detail was thoughtfully considered to balance imagination and comfort — creating a space that grows with the child and sparks curiosity from the very beginning.',
    shortDescription: 'Safari-themed nursery with earthy tones and playful wildlife references for a nurturing, imaginative space.',
    coverImage: '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-1.png',
    images: [
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-1.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-2.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-3.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-4.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-5.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-6.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-7.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-8.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-9.png',
      '/images/projects/safari-nursery/ARQMA_NURSERY_ROOM_HAMILTON-10.png',
    ],
    tags: ['Residential', 'Nursery', 'Custom Design'],
  },
]
